...
public class GmailAuthService {
    ...
    private static final String CREDENTIALS_FILE_PATH = "/gmail-api-credentials.json";
    ...
    public Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT)
        ...
        if (in == null) {
            throw new FileNotFoundException("Unable to read credentials resource file: " + CREDENTIALS_FILE_PATH);
        }
